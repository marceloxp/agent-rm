...
DENY_MSG='Blocked (agent-rm): do not permanently delete files or empty the trash. Use '\''agent-rm <file>'\'' — one file at a time, no directories; goes to restorable trash (see '\''agent-rm --help'\'' to restore).'
